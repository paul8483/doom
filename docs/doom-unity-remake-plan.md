...
Превратить «прогулку» в игру. Реализуется поэтапно, каждый пункт — отдельная веха. Этап разбит на под-этапы 6a–6f; 6a (двери и интерактивные секторы), 6b (урон игроку и HP) и 6c (оружие и стрельба) завершены; **6d (ИИ врагов) в работе** — Tasks 1–11 в git; баг спрайта POSS/SPOS исправлен (2026-07-10); остаётся Task 12 (визуальная приёмка + docs).

- Здоровье, броня, урон. ✅ (под-этап 6b)
- Оружие и стрельба. ✅ (под-этап 6c)
- ИИ врагов (преследование, атака, смерть). 🔄 (под-этап 6d, Tasks 1–11 ✅; facing-баг ✅; Task 12)
