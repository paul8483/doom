...
**Дата:** 2026-07-10
**Статус:** SFX реализованы (Tasks 1–6); музыка (Tasks 7–9) ещё не начата
...
- Полный звуковой набор ещё не реализованных механик: телепорты, crusher,
  exit, секреты, chainsaw/rocket/plasma/BFG.
