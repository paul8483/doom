...
- **Анимированные лумпы** (например `BON1` A–D, BEXP бочки) в 2D-уровне
  остаются на EdgeMix, пока не перерисованы **все** кадры — иначе «моргание»
  улучшенных и нативных кадров.
- EdgeMix — переходный fallback (решение 2026-08-07): лумп уходит с него,
  когда его покрывает redraw/меш; удаление EdgeMix вне scope этой фичи.
