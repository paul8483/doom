...
namespace Doom.MapBuild.Editor
{
    ...
    public static class ThreeDToggleGate1PreviewMenu
    {
        ...
        static readonly (string Lump, string Label, bool ExpectRedraw, bool ExpectMesh)[] Rows =
        {
            ...
            ("AMMOA0", "AMMOA0-bullet-box", true, true),
            ("SHELA0", "SHELA0-shells", true, true),
            ("SBOXA0", "SBOXA0-shell-box", true, true),
            ("ROCKA0", "ROCKA0-rocket", true, true),
            ("CELLA0", "CELLA0-cell", true, true),
            ("CELPA0", "CELPA0-cell-pack", true, true),
