...
Date: 2026-08-24 22:59
| Metric | Value |
|--------|-------|
| Map build time | 1,31s |
| Classic→Enhanced first switch (yielded warm) | 7,97s |
| Avg repeat switch (20×, timeScale=0) | 14,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,63s |
| Classic→Enhanced first switch (yielded warm) | 8,16s |
| Repeat Classic↔Enhanced (warm) | 13,5ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1134,4 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-24 23:25
| Metric | Value |
|--------|-------|
| Map build time | 1,31s |
| Classic→Enhanced first switch (yielded warm) | 7,80s |
| Avg repeat switch (20×, timeScale=0) | 14,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 8,09s |
| Repeat Classic↔Enhanced (warm) | 12,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1141,2 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-24 23:59
| Metric | Value |
|--------|-------|
| Map build time | 1,32s |
| Classic→Enhanced first switch (yielded warm) | 8,08s |
| Avg repeat switch (20×, timeScale=0) | 14,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,62s |
| Classic→Enhanced first switch (yielded warm) | 8,19s |
| Repeat Classic↔Enhanced (warm) | 13,8ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1042,6 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 1,28s |
| Classic→Enhanced first switch (yielded warm) | 7,98s |
| Avg repeat switch (20×, timeScale=0) | 13,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1145,5 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-25 01:31
| Metric | Value |
|--------|-------|
| Map build time | 1,44s |
| Classic→Enhanced first switch (yielded warm) | 7,63s |
| Avg repeat switch (20×, timeScale=0) | 17,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,62s |
| Classic→Enhanced first switch (yielded warm) | 8,00s |
| Repeat Classic↔Enhanced (warm) | 13,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1120,7 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-25 13:03
| Metric | Value |
|--------|-------|
| Map build time | 1,29s |
| Classic→Enhanced first switch (yielded warm) | 7,53s |
| Avg repeat switch (20×, timeScale=0) | 17,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
Date: 2026-08-25 13:04
| Metric | Value |
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 7,74s |
| Repeat Classic↔Enhanced (warm) | 12,8ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1123,7 MB |
| Mitigation ladder | none applied |
...
| Metric | Value |
|--------|-------|
| Map build time | 1,27s |
| Classic→Enhanced first switch (yielded warm) | 7,06s |
| Avg repeat switch (20×, timeScale=0) | 13,2ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 7,65s |
| Repeat Classic↔Enhanced (warm) | 13,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1024,9 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-26 00:56
| Metric | Value |
|--------|-------|
| Map build time | 1,29s |
| Classic→Enhanced first switch (yielded warm) | 7,14s |
| Avg repeat switch (20×, timeScale=0) | 14,2ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
| Metric | Value |
|--------|-------|
| Map build time | 0,65s |
| Classic→Enhanced first switch (yielded warm) | 7,78s |
| Repeat Classic↔Enhanced (warm) | 12,2ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1030,2 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-26 01:34
| Metric | Value |
|--------|-------|
| Map build time | 1,40s |
| Classic→Enhanced first switch (yielded warm) | 7,60s |
| Avg repeat switch (20×, timeScale=0) | 16,4ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
Date: 2026-08-26 01:35
| Metric | Value |
|--------|-------|
| Map build time | 0,62s |
| Classic→Enhanced first switch (yielded warm) | 7,61s |
| Repeat Classic↔Enhanced (warm) | 13,8ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1119,1 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-26 01:54
| Metric | Value |
|--------|-------|
| Map build time | 1,41s |
| Classic→Enhanced first switch (yielded warm) | 7,26s |
| Avg repeat switch (20×, timeScale=0) | 14,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,63s |
| Classic→Enhanced first switch (yielded warm) | 7,91s |
| Repeat Classic↔Enhanced (warm) | 11,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1027,9 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-26 01:59
| Metric | Value |
|--------|-------|
| Map build time | 1,42s |
| Classic→Enhanced first switch (yielded warm) | 8,77s |
| Avg repeat switch (20×, timeScale=0) | 21,1ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
Date: 2026-08-26 02:00
| Metric | Value |
|--------|-------|
| Map build time | 0,62s |
| Classic→Enhanced first switch (yielded warm) | 8,02s |
| Repeat Classic↔Enhanced (warm) | 12,4ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1041,8 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 1,30s |
| Classic→Enhanced first switch (yielded warm) | 6,82s |
| Avg repeat switch (20×, timeScale=0) | 16,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
Date: 2026-08-26 12:52
| Metric | Value |
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 7,48s |
| Repeat Classic↔Enhanced (warm) | 12,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1123,8 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 1,28s |
| Classic→Enhanced first switch (yielded warm) | 8,17s |
| Avg repeat switch (20×, timeScale=0) | 14,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 7,35s |
| Repeat Classic↔Enhanced (warm) | 12,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1041,6 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-27 01:05
| Metric | Value |
|--------|-------|
| Map build time | 1,31s |
| Classic→Enhanced first switch (yielded warm) | 8,47s |
| Avg repeat switch (20×, timeScale=0) | 14,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1446 / 330 / 240 |
| EnhancedVariantCount | 240 |
| Enhanced 4× albedo bytes | 154,2 MB |
| Normal+height bytes | 154,2 MB |
...
|--------|-------|
| Map build time | 0,61s |
| Classic→Enhanced first switch (yielded warm) | 5,92s |
| Repeat Classic↔Enhanced (warm) | 27,1ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1120,3 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-27 02:13
| Metric | Value |
|--------|-------|
| Map build time | 1,31s |
| Classic→Enhanced first switch (yielded warm) | 6,69s |
| Avg repeat switch (20×, timeScale=0) | 15,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1449 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
| Sprite Enhanced bytes | 8,6 MB |
| HUD Enhanced bytes | 2,8 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 0,62s |
| Classic→Enhanced first switch (yielded warm) | 7,49s |
| Repeat Classic↔Enhanced (warm) | 13,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1389 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 7,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1149,2 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-27 22:47
| Metric | Value |
|--------|-------|
| Map build time | 1,32s |
| Classic→Enhanced first switch (yielded warm) | 6,34s |
| Avg repeat switch (20×, timeScale=0) | 14,1ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M1)

Date: 2026-08-27 22:48
| Metric | Value |
|--------|-------|
| Map build time | 0,63s |
| Classic→Enhanced first switch (yielded warm) | 7,20s |
| Repeat Classic↔Enhanced (warm) | 15,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
| Normal+height bytes | 158,4 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1213,3 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-29 16:31
| Metric | Value |
|--------|-------|
| Map build time | 1,55s |
| Classic→Enhanced first switch (yielded warm) | 7,59s |
| Avg repeat switch (20×, timeScale=0) | 18,8ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
| Metric | Value |
|--------|-------|
| Map build time | 0,77s |
| Classic→Enhanced first switch (yielded warm) | 8,19s |
| Repeat Classic↔Enhanced (warm) | 16,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1191,6 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-29 19:35
| Metric | Value |
|--------|-------|
| Map build time | 1,54s |
| Classic→Enhanced first switch (yielded warm) | 7,62s |
| Avg repeat switch (20×, timeScale=0) | 18,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
...
Date: 2026-08-29 19:36
| Metric | Value |
|--------|-------|
| Map build time | 0,73s |
| Classic→Enhanced first switch (yielded warm) | 7,86s |
| Repeat Classic↔Enhanced (warm) | 16,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1189,0 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 00:19
| Metric | Value |
|--------|-------|
| Map build time | 1,59s |
| Classic→Enhanced first switch (yielded warm) | 7,10s |
| Avg repeat switch (20×, timeScale=0) | 18,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
Date: 2026-08-30 00:20
| Metric | Value |
|--------|-------|
| Map build time | 0,88s |
| Classic→Enhanced first switch (yielded warm) | 7,17s |
| Repeat Classic↔Enhanced (warm) | 16,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1206,2 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 02:35
| Metric | Value |
|--------|-------|
| Map build time | 1,57s |
| Classic→Enhanced first switch (yielded warm) | 6,97s |
| Avg repeat switch (20×, timeScale=0) | 17,4ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
| Metric | Value |
|--------|-------|
| Map build time | 0,78s |
| Classic→Enhanced first switch (yielded warm) | 7,06s |
| Repeat Classic↔Enhanced (warm) | 17,8ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1224,0 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 02:45
| Metric | Value |
|--------|-------|
| Map build time | 1,55s |
| Classic→Enhanced first switch (yielded warm) | 7,18s |
| Avg repeat switch (20×, timeScale=0) | 17,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1471 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
Date: 2026-08-30 02:46
| Metric | Value |
|--------|-------|
| Map build time | 0,74s |
| Classic→Enhanced first switch (yielded warm) | 7,06s |
| Repeat Classic↔Enhanced (warm) | 15,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1415 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1185,2 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 16:34
| Metric | Value |
|--------|-------|
| Map build time | 1,53s |
| Classic→Enhanced first switch (yielded warm) | 6,79s |
| Avg repeat switch (20×, timeScale=0) | 18,4ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
| Sprite Enhanced bytes | 16,9 MB |
...
Date: 2026-08-30 16:35
| Metric | Value |
|--------|-------|
| Map build time | 0,77s |
| Classic→Enhanced first switch (yielded warm) | 7,05s |
| Repeat Classic↔Enhanced (warm) | 15,4ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
| Normal+height bytes | 158,4 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1213,7 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 17:58
| Metric | Value |
|--------|-------|
| Map build time | 1,57s |
| Classic→Enhanced first switch (yielded warm) | 7,49s |
| Avg repeat switch (20×, timeScale=0) | 20,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
|--------|-------|
| Map build time | 0,73s |
| Classic→Enhanced first switch (yielded warm) | 7,23s |
| Repeat Classic↔Enhanced (warm) | 16,5ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1209,3 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-08-30 21:34
| Metric | Value |
|--------|-------|
| Map build time | 1,56s |
| Classic→Enhanced first switch (yielded warm) | 7,16s |
| Avg repeat switch (20×, timeScale=0) | 19,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
| Metric | Value |
|--------|-------|
| Map build time | 0,70s |
| Classic→Enhanced first switch (yielded warm) | 7,09s |
| Repeat Classic↔Enhanced (warm) | 16,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1170,4 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-01 20:44
| Metric | Value |
|--------|-------|
| Map build time | 0,85s |
| Classic→Enhanced first switch (yielded warm) | 3,37s |
| Avg repeat switch (20×, timeScale=0) | 8,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
|--------|-------|
| Map build time | 0,43s |
| Classic→Enhanced first switch (yielded warm) | 2,69s |
| Repeat Classic↔Enhanced (warm) | 8,2ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1223,8 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-01 23:18
| Metric | Value |
|--------|-------|
| Map build time | 0,83s |
| Classic→Enhanced first switch (yielded warm) | 3,37s |
| Avg repeat switch (20×, timeScale=0) | 8,1ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
|--------|-------|
| Map build time | 0,43s |
| Classic→Enhanced first switch (yielded warm) | 2,64s |
| Repeat Classic↔Enhanced (warm) | 7,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
| Enhanced 4× albedo bytes | 158,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1214,7 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-02 02:07
| Metric | Value |
|--------|-------|
| Map build time | 0,87s |
| Classic→Enhanced first switch (yielded warm) | 3,39s |
| Avg repeat switch (20×, timeScale=0) | 8,2ms |
| TextureCount / MaterialCount / NormalMapCount | 1483 / 332 / 241 |
| EnhancedVariantCount | 241 |
| Enhanced 4× albedo bytes | 154,8 MB |
| Normal+height bytes | 154,8 MB |
...
|--------|-------|
| Map build time | 0,44s |
| Classic→Enhanced first switch (yielded warm) | 2,65s |
| Repeat Classic↔Enhanced (warm) | 7,9ms |
| TextureCount / MaterialCount / NormalMapCount | 1429 / 316 / 231 |
| EnhancedVariantCount | 231 |
| Native albedo bytes | 7,4 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1156,9 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-02 07:55
| Metric | Value |
|--------|-------|
| Map build time | 0,86s |
| Classic→Enhanced first switch (yielded warm) | 3,02s |
| Avg repeat switch (20×, timeScale=0) | 9,1ms |
| TextureCount / MaterialCount / NormalMapCount | 1504 / 346 / 248 |
| EnhancedVariantCount | 248 |
| Enhanced 4× albedo bytes | 159,7 MB |
| Normal+height bytes | 159,7 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 0,44s |
| Classic→Enhanced first switch (yielded warm) | 2,45s |
| Repeat Classic↔Enhanced (warm) | 8,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1435 / 320 / 233 |
| EnhancedVariantCount | 233 |
| Native albedo bytes | 7,5 MB |
| Enhanced 4× albedo bytes | 159,7 MB |
| Normal+height bytes | 159,7 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1167,5 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-02 13:47
| Metric | Value |
|--------|-------|
| Map build time | 0,94s |
| Classic→Enhanced first switch (yielded warm) | 3,38s |
| Avg repeat switch (20×, timeScale=0) | 9,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1504 / 346 / 248 |
| EnhancedVariantCount | 248 |
| Enhanced 4× albedo bytes | 167,7 MB |
| Normal+height bytes | 167,7 MB |
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Mitigation ladder | none applied |
...
| Map build time | 0,49s |
| Classic→Enhanced first switch (yielded warm) | 2,69s |
| Repeat Classic↔Enhanced (warm) | 8,3ms |
| TextureCount / MaterialCount / NormalMapCount | 1435 / 320 / 233 |
| EnhancedVariantCount | 233 |
| Native albedo bytes | 7,5 MB |
| Enhanced 4× albedo bytes | 167,7 MB |
...
| Sprite Enhanced bytes | 16,9 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1274,7 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-03 00:51
| Metric | Value |
|--------|-------|
| Map build time | 0,60s |
| Classic→Enhanced first switch (yielded warm) | 2,94s |
| Avg repeat switch (20×, timeScale=0) | 11,6ms |
| TextureCount / MaterialCount / NormalMapCount | 1508 / 346 / 248 |
| EnhancedVariantCount | 248 |
| Enhanced 4× albedo bytes | 167,7 MB |
| Normal+height bytes | 167,7 MB |
| Sprite Enhanced bytes | 17,0 MB |
| HUD Enhanced bytes | 2,8 MB |
| Mitigation ladder | none applied |
...
|--------|-------|
| Map build time | 0,42s |
| Classic→Enhanced first switch (yielded warm) | 3,24s |
| Repeat Classic↔Enhanced (warm) | 7,7ms |
| TextureCount / MaterialCount / NormalMapCount | 1425 / 320 / 233 |
| EnhancedVariantCount | 233 |
| Native albedo bytes | 7,5 MB |
| Enhanced 4× albedo bytes | 167,7 MB |
| Normal+height bytes | 167,7 MB |
| Sprite Enhanced bytes | 15,7 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1061,5 MB |
| Mitigation ladder | none applied |

## Task 9 performance gate (E1M7)

Date: 2026-09-03 00:56
| Metric | Value |
|--------|-------|
| Map build time | 0,59s |
| Classic→Enhanced first switch (yielded warm) | 3,40s |
| Avg repeat switch (20×, timeScale=0) | 9,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1508 / 346 / 248 |
| EnhancedVariantCount | 248 |
| Enhanced 4× albedo bytes | 167,7 MB |
| Normal+height bytes | 167,7 MB |
...
Date: 2026-09-03 00:57
| Metric | Value |
|--------|-------|
| Map build time | 0,37s |
| Classic→Enhanced first switch (yielded warm) | 3,15s |
| Repeat Classic↔Enhanced (warm) | 9,0ms |
| TextureCount / MaterialCount / NormalMapCount | 1425 / 320 / 233 |
| EnhancedVariantCount | 233 |
| Native albedo bytes | 7,5 MB |
| Enhanced 4× albedo bytes | 167,7 MB |
...
| Sprite Enhanced bytes | 15,7 MB |
| HUD Enhanced bytes | 2,8 MB |
| Managed (GC.GetTotalMemory) | 1116,3 MB |
| Mitigation ladder | none applied |
