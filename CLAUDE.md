...
Stages 0, 1, 2, 3, 4, and 5 of the plan are done; Stage 6 is split into sub-stages 6a–6f. Sub-stages 6a, 6b, 6c, and **6d (monster AI) are done**; **next is 6e (pickups)** — spec `docs/superpowers/specs/2026-07-10-pickups-design.md`, plan `docs/superpowers/plans/2026-07-10-pickups.md` (not started); then 6f (sound).
...
The current test suite is **193 EditMode + 20 PlayMode** tests:
