...
The plan is in `docs/doom-unity-remake-plan.md` (written in Russian); Stage 1's detailed plan is in `docs/stage-1-wad-reader-plan.md`; Stage 2's detailed plan is in `docs/stage-2-geometry-plan.md`; Stage 3's detailed plan is in `docs/stage-3-player-plan.md`. Stage 4 (palette and textures) is the next concrete work.
