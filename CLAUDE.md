...
The master roadmap is in `docs/doom-unity-remake-plan.md` (written in Russian); detailed per-stage specs live under `docs/superpowers/specs/`: Stage 1 in `stage-1-wad-reader-plan.md`, Stage 2 in `stage-2-geometry-plan.md`, Stage 3 in `stage-3-player-plan.md`, and the Stage 4 design in `2026-05-30-stage-4-textures-design.md`. Stage 4 (palette and textures) is the next concrete work.
