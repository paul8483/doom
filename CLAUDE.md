...
Stages 0, 1, 2, 3, 4, and 5 of the plan are done; Stage 6 is split into sub-stages 6a–6f. Sub-stages 6a, 6b, 6c, and **6d (monster AI) are done**; **next is 6e** (pickups) / **6f** (sound) per the roadmap.
